...
ext_modules = [Extension("engine._siddon_func", ["engine//_siddon_func.pyx"], include_dirs=[numpy_dirs], extra_compile_args=['-O3'])]
ext_modules += [Extension("engine._interaction_func", ["engine//_interaction_func.pyx"], include_dirs=[numpy_dirs], extra_compile_args=['-fopenmp', '-O3'], extra_link_args=['-fopenmp'])]
ext_modules += [Extension("engine.cyrandom", ["engine//cyrandom.pyx"], include_dirs=[numpy_dirs], extra_compile_args=['-O3'])]
