...
static char __pyx_k_C_test_OpenDXMC_opendxmc_engine[] = "C:\\test\\OpenDXMC\\opendxmc\\engine\\cyrandom.pyx";
 ...
 */
  ...
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(1, 0, 1, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_test_OpenDXMC_opendxmc_engine, __pyx_n_s_py_nbits, 523, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 523; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
