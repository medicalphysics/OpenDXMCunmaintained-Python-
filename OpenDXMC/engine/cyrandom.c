...
static char __pyx_k_C_GitHub_OpenDXMC_opendxmc_engin[] = "C:\\GitHub\\OpenDXMC\\opendxmc\\engine\\cyrandom.pyx";
 ...
 */
  ...
  __pyx_t_5 = __Pyx_GetItemInt_Tuple(__pyx_v_state_var, -1, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(__pyx_t_5 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_5);
 ...
 *     """
 */
  __pyx_tuple__24 = PyTuple_Pack(1, __pyx_n_s_n); if (unlikely(!__pyx_tuple__24)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 523; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__24);
  __Pyx_GIVEREF(__pyx_tuple__24);
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(1, 0, 1, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_GitHub_OpenDXMC_opendxmc_engin, __pyx_n_s_py_nbits, 523, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 523; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    if (likely(PyLong_Check(x))) {
        if (is_unsigned) {
            ...
            if (sizeof(npy_uint64) <= sizeof(unsigned long)) {
                ...
                __PYX_VERIFY_RETURN_INT(npy_uint64, unsigned PY_LONG_LONG, PyLong_AsUnsignedLongLong(x))
            }
        } else {
#if CYTHON_COMPILING_IN_CPYTHON && PY_MAJOR_VERSION >= 3
 #if CYTHON_USE_PYLONG_INTERNALS
            ...
            if (sizeof(npy_uint64) <= sizeof(long)) {
                ...
                __PYX_VERIFY_RETURN_INT(npy_uint64, PY_LONG_LONG, PyLong_AsLongLong(x))
            }
        }
        {
