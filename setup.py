...
ext_modules = [Extension("engine._siddon_func", ["engine//_siddon_func.pyx"], include_dirs=[numpy_dirs])]
...
ext_modules += [Extension("engine.cyrandom", ["engine//cyrandom.pyx"], include_dirs=[numpy_dirs])]
